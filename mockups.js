...
<text x="130" y="133" text-anchor="middle" font-family="'Helvetica Neue',Arial,sans-serif" font-size="15" font-weight="300" letter-spacing="4" fill="#1a1a2e">${nombreProducto}</text>
...
<text x="140" y="156" text-anchor="middle" font-family="'Helvetica Neue',Arial,sans-serif" font-size="6.5" letter-spacing="2" fill="#666">${marcaLabel}</text>
